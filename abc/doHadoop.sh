...
javac ABC.java -d units -cp $(/home/ganeshkumar269/hadoop/hadoop-3.3.0/bin/hadoop classpath):. &&
jar -cvf units.jar -C units/ . &&
~/hadoop/hadoop-3.3.0/bin/hadoop jar units.jar hadoop.ABC input_dir output_dir
# ~/hadoop/hadoop-3.3.0/sbin/stop-all.sh 
# ~/hadoop/hadoop-3.3.0/bin/hadoop dfsadmin -safemode leave
